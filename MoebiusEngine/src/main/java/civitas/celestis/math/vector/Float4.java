...
/**
 * An immutable four-dimensional vector which uses {@code float}s to represent its components.
 */
public class Float4 extends Number implements FloatVector<Float4> {
    //
    // Constants
    //
    ...
    @Nonnull
    @Override
    public Float4 transform(@Nonnull UnaryOperator<Float> transformer) {
        return new Float4(transformer.apply(w), transformer.apply(x), transformer.apply(y), transformer.apply(z));
    }
     ...
     * @return {@code true} if the other object is a {@link Float4}, and the component values are equal
     */
    @Override
    public boolean equals(@Nullable Object obj) {
        if (!(obj instanceof Float4 v)) return false;
        return w == v.w && x == v.x && y == v.y && z == v.z;
    }
    ...
    /**
     * Deserializes a string into a {@link Float4}.
     *
    ...
    public static Float4 parseVector(@Nonnull String input) throws NumberFormatException {
        ...
        final String cleanInput = input.replaceAll("Float4\\{|}", "");
        ...
        for (final String valueString : valueStrings) {
            ...
            values[switch (split[0]) {
                ...
                case "y" -> 2;
                case "z" -> 3;
                default -> throw new NumberFormatException("The provided string does not represent a Float4.");
