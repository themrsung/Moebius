...
/**
 * Contains geometric utility methods.
 */
public final class Geometry {
    ...
    public static boolean intersects(@Nonnull Face face, @Nonnull Ray ray) {
        ...
        final Vector3 q2 = ray.destination(face.getCentroid().distance2(q1));
    ...
    public static Vector3 intersection(@Nonnull Face face, @Nonnull Ray ray) {
        ...
        final Vertex p1 = face.getA();
        final Vertex p2 = face.getB();
        final Vertex p3 = face.getC();
