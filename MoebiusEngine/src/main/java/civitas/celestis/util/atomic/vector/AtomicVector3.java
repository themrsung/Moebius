 ...
 */
public class AtomicVector3 extends AtomicReference<Vector3> implements AtomicVector<Vector3> {
    //
    // Constructors
    //
     ...
     */
    @Override
    public void add(@Nonnull Vector3 v) throws NullPointerException {
        final Vector3 ref = get();
        if (ref == null) throw new NullPointerException("Reference points to null.");
        set(ref.add(v));
    }
     ...
     */
    @Override
    public void subtract(@Nonnull Vector3 v) throws NullPointerException {
        final Vector3 ref = get();
        if (ref == null) throw new NullPointerException("Reference points to null.");
        set(ref.subtract(v));
    }
     ...
     */
    @Override
    public void multiply(@Nonnull Vector3 v) throws NullPointerException {
        final Vector3 ref = get();
        if (ref == null) throw new NullPointerException("Reference points to null.");
        set(ref.multiply(v));
    }
     ...
     */
    @Override
    public void min(@Nonnull Vector3 v) throws NullPointerException {
        final Vector3 ref = get();
        if (ref == null) throw new NullPointerException("Reference points to null.");
        set(ref.min(v));
    }
     ...
     */
    @Override
    public void max(@Nonnull Vector3 v) throws NullPointerException {
        final Vector3 ref = get();
        if (ref == null) throw new NullPointerException("Reference points to null.");
        set(ref.max(v));
    }
     ...
     */
    @Override
    public void clamp(@Nonnull Vector3 min, @Nonnull Vector3 max) throws NullPointerException {
        final Vector3 ref = get();
        if (ref == null) throw new NullPointerException("Reference points to null.");
